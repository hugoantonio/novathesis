...
\title[A Framework for Precision Agriculture Mapping using Geographic Information Systems]{A framework for Precision Agriculture Mapping using Geographic Information Systems}
\subtitle{Science is beautiful}

% Autor
% use [f] for female and [m] for male
\authorname[m]{Hugo Gonçalves Pereira António}{Hugo António}
\authordegree{Degree in Computer Science}
